...
const ChatInput: React.FC = () => (
    <form className="w-full bg-white rounded-2xl border border-alice-gray p-3 sm:p-4 md:p-6 flex flex-col gap-2 my-4 lg:my-6">
