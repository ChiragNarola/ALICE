...
const ChatMessage: React.FC<ChatMessageProps> = ({ from, text, actions, userimg }) => {
    ...
    return (
        <div className={`flex ${isAlice ? "flex-row" : "flex-row-reverse"} items-end gap-[6px] sm:gap-[10px]`}>
            ...
            {/* Message bubble */}
            <div className={`max-w-[80vw] sm:max-w-[1039px] w-full rounded-2xl p-3 sm:p-4 lg:p-6 ${isAlice ? "bg-[#0080800D] text-alice-black rounded-bl-none" : "bg-[#1B1B1B0D] text-alice-black rounded-br-none"}`}>
