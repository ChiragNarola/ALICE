...
function handleDelete(idx: number, child_id: string | number | undefined) {
  ...
  return (
   ...
   {isloading ? (
  <div className="flex justify-center h-[300px] items-center py-6">
    ...
    {fields.map((field, idx) => (
      ...
      >
        ...
        <div className="mb-6 lg:mb-9">
          <label className="block text-base font-semibold mb-3 text-alice-black">
            Gender
          </label>
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-6 lg:mb-9">
          <div className="flex-1 min-w-[120px]">
            ...
            {errors?.children?.[idx]?.dob && (
              <p className="text-red-500 text-sm mt-1">
                {errors.children[idx].dob?.message}
              </p>
            )}
          </div>
        </div>
