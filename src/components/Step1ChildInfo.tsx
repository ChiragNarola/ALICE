...
const Step1ChildInfo = forwardRef<{ validateAndSubmit: () => Promise<boolean> }, {}>((_, ref) => {
...
useImperativeHandle(ref, () => ({
  ...
  getValues: () => {
    return getValues(); // This returns { children: [...] }
  },
}));
          ...
          render={({ field }) => (
            <input
              ...
              className={`w-full px-5 py-[14px] lg:py-[18px] border rounded-[12px] mt-[-10px] lg:mt-[-12px] bg-white placeholder:text-alice-darkgray text-alice-black text-[14px] lg:text-base font-normal outline-[.2px] focus:outline-alice-teal ${
                errors?.children?.[idx]?.firstName ? 'border-red-500' : 'border-alice-gray'
              }`}
            />
          )}
        />
  ...
  render={({ field }) => (
    <input
      ...
      className={`w-full px-5 py-[14px] lg:py-[18px] border rounded-[12px] mt-[-10px] lg:mt-[-12px] bg-white placeholder:text-alice-darkgray text-alice-black text-[14px] lg:text-base font-normal outline-[.2px] focus:outline-alice-teal ${
        errors?.children?.[idx]?.middleName ? 'border-red-500' : 'border-alice-gray'
      }`}
    />
  )}
/>
        ...
        <Controller
          ...
          render={({ field }) => (
            <input
              ...
              className={`w-full px-5 py-[14px] lg:py-[18px] border rounded-[12px] mt-[-10px] lg:mt-[-12px] bg-white placeholder:text-alice-darkgray text-alice-black text-[14px] lg:text-base font-normal outline-[.2px] focus:outline-alice-teal ${
                errors?.children?.[idx]?.lastName ? 'border-red-500' : 'border-alice-gray'
              }`}
            />
          )}
        />
        ...
        <Controller
          ...
          render={({ field }) => (
            <input
              ...
              {...field}
              className={`w-full px-5 py-[14px] lg:py-[18px] border rounded-[12px] mt-[-10px] lg:mt-[-12px] bg-white placeholder:text-alice-darkgray text-alice-black text-[14px] lg:text-base font-normal outline-[.2px] focus:outline-alice-teal ${
                errors?.children?.[idx]?.dob ? 'border-red-500' : 'border-alice-gray'
              }`}
            />
          )}
        />
